...
exports.logRate = exports.repeat = exports.repeatBase = exports.asyncEach = exports.highestQuality = exports.uniqueArr = exports.isChannelThrow = exports.isChannel = exports.correctServices = void 0;
...
const isChannel = (channel) => /^[a-zA-Z0-9_]{4,25}$/.test(channel);
exports.isChannel = isChannel;
const isChannelThrow = (channel) => {
    if ((0, exports.isChannel)(channel))
        return channel;
